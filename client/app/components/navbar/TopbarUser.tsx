...
const TopbarUser = ({setOpenStudyTimer,toggleUserOptionsDropDown}:ITopbarUserProps) => {
    return ( 
        ...
        <li className={`ms-4 me-4 rounded-lg px-4 py-2 mt-4 hover:bg-yellow-400 hover:text-black hover:border-black hover:rounded-full hover:cursor-pointer`} onClick={()=> toggleUserOptionsDropDown()}>
