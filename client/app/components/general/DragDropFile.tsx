const DragDropFile = () => {
    return (
        <div className="flex items-center justify-center w-full">
            <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-yellow-600 border-dashed rounded-lg cursor-pointer hover:bg-black bg-bitBrown">
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                    ...
                    <p className="text-xs text-yellow-600">PNG, JPG, PDF, MP4</p>
                </div>
