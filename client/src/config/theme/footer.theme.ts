export const footerNavigation=()=>{
    return "px-2 cursor-pointer underline hover:text-yellow-600";
}

export const footerIcons=()=>{
    return "px-2 cursor-pointer hover:rounded-lg hover:text-yellow-600";
}
...
export const footerIconList: string = `
    flex justify-between items-center px-4 py-2
`;
